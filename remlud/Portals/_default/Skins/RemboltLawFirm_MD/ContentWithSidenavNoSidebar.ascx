            ...
            <div id="page_content">
                ...
                <div id="pc_main_content">
                    ...
                    <div id="content_holder">
                        <div id="dynamic_area_nosidebar">
                            <div id="ContentPane" runat="server"  ></div>
                            <div id="videoclick" href="" style="width:480px;"></div>
...
<dnn:DnnJsInclude ID="DnnJsInclude1" runat="server" FilePath="Scripts/jQueryRotate.2.2.js" PathNameAlias="SkinPath" />
...
<script type="text/javascript" >
    ...
    (function ($) {
        ...
        $(document).ready(function () {
           flowplayer("a.video", "/Portals/_default/Skins/RemboltLawFirm_MD/Scripts/flowplayer/flowplayer-3.2.12.swf");
