...
<asp:DataList ID="lstArchiveMonths" runat="server" Width="100%" CssClass="CommandButton bluetext"
 CellPadding="0" CellSpacing="0" BorderWidth="0">
 <ItemTemplate>
  <table width="100%" cellpadding="0" cellspacing="0" border="0" align="left">
   <tr>
    <td align="left">
     <asp:HyperLink runat="server" ID="lnkMonthYear" CssClass="CommandButton bluetext" NavigateUrl="default.aspx" />
    </td>
    <td align="right">
...
<br /><asp:DropDownList ID="ddlArchiveMonths" runat="server" Visible="false" CssClass="NormalTextBox" /><asp:LinkButton ID="cmdGo" runat="server" resourcekey="cmdGo" CssClass="CommandButton bluetext" />