jQuery(document).ready(function ($) {
	...
	function setDimensions(obj) {	
		...
		maxHeight = 36;
		numColumns = 1;
		maxColumns = 1; // set to desired number of colummns
		...
		obj.find("li.category").each(function () { //for each ul...					
		    maxHeight = ($(this).height() > maxHeight) ? maxHeight : $(this).height(); //Check current category height against largest height
		});
