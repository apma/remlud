...
<div class="dnnForm dnnViewEntry dnnClear">
 ...
 <div class="left_small_shadow"></div>
	...
	<div class="vbHeader dnnClear">
		<asp:Label ID="lblDateTime" CssClass="BlogDate RLTimeStamp" runat="server" />
		<div class="dnnRight">
            <asp:HyperLink ID="hlAuthor" runat="server" CssClass="RLAuthor" />
			
		</div>
	</div>
    <h2 id="lblBlogTitle" runat="server" class="BlogTitle"/>
