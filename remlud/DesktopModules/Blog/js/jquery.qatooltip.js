...
(function($){$.fn.qaTooltip=function(options){var opts=$.extend({},$.fn.qaTooltip.defaultOptions,options),$wrap=this;$wrap.each(function(){var $this=$(this);function hoverOver(){if(opts.useParentActiveClass){$this.addClass(opts.parentActiveClass);}
$this.find(opts.tooltipSelector).show();}
function hoverOut(){if(opts.useParentActiveClass){$this.removeClass(opts.parentActiveClass);}
